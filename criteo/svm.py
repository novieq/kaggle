...
train = 'train_test.csv'  # path to training file
test = 'test_test.csv'  # path to testing file
...
def get_x(csv_row, D):
    ...
    for key, value in csv_row.items():
        ...
        x.append(index)
#	print key + " " + value + " " + str(index) + " " + key[1:]
...
for t, row in enumerate(DictReader(open(train))):
    ...
    #print "Get the hashed features"
    print "Row : "  
    print row
    x = get_x(row, D)
    print "Hashed Feature : "  
    print x
